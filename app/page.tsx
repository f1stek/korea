...
export default function App() {
  ...
  const AFFILIATE_LINK = 'https://ptgateway.com/v1/process/376?landing=/signup&token1=youtube';
  ...
  const handleTowerRushClick = async () => {
    try {
      await supabase.from('clicks').insert([{ ip: 'user_click', device: 'mobile/pc', geo: 'KR', status: 'clicked' }]);
    ...
    <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center py-12 px-4 font-sans overflow-x-hidden relative">
      ...
      <div className="relative z-10 w-full max-w-lg flex flex-col items-center">
        <div className="text-center mb-10 group">
          ...
          <div className="relative">
            ...
            <h1 className="relative text-6xl md:text-7xl font-black italic tracking-tighter leading-none mb-2">
              ...
              <span className="text-red-500 [text-shadow:0_0_20px_#dc2626]">RUSH</span>
            </h1>
        ...
        <div className="w-full bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 mb-8 relative overflow-hidden group">
          ...
          <div className="relative z-10 flex justify-between items-center mb-6 text-left">
          ...
          <button onClick={handleTowerRushClick} className="relative z-10 w-full group flex items-center justify-center gap-3 py-6 rounded-2xl font-black text-xl bg-cyan-500 text-black hover:bg-white transition-all active:scale-95 shadow-[0_0_30px_rgba(6,182,212,0.4)]">
            지금 바로 시작하기
